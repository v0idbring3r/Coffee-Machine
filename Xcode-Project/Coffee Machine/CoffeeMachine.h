...
/**
 ...
 - The capacity for each different ingredient type is fixed and same for all ingredients (I've set it up as 1000 for now). We can support different capacities by including those values in the available_items property.
...
public:
    CoffeeMachine(int outlets, const IngredientList& total_items_available, int capacity = 1000);
